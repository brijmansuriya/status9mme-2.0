...
import { Save, Eye, Upload, X, Plus, Trash2, ArrowLeft } from 'lucide-react';
...
export default function Create({ categories }: CreateProps) {
    ...
    return (
        <>
            <Head title="Create Template - Admin Panel" />
                    ...
                    <div className="mb-8">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Add a new video template to the platform</p>
                            </div>
                        </div>
                    </div>
